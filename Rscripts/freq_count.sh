...
xsv select panelist_id ../processed_data/desktop/uk.csv | sort | uniq -c | wc -l > ../processed_data/stats/us_uniq_panelists.csv
...
xsv search -s type 'news' ../processed_data/desktop/uk.csv | xsv select panelist_id | sort | uniq -c | wc -l > ../processed_data/stats/us_uniq_panelists_news.csv
