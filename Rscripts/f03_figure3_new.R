...
tbl <- bind_rows(seg_scores_long,
                 readRDS("processed_data/diversity_scores.RDS"),
                 readRDS("processed_data/mean_of_abs_indiv_news_diet.RDS"))
...
pdf("figures/figure3_new.pdf", height = 16, width = 16)
wrap_plots(tst)+
